...
public class OldRaceActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, RealTimeMessageReceivedListener, RoomStatusUpdateListener, RoomUpdateListener{
    private static final String TAG = "OldRaceActivity";
...
//                Games.RealTimeMultiplayer.create(mGoogleApiClient, roomConfig);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_AUTOMATCH) {
            ...
            RoomConfig roomConfig = RoomConfig.builder(OldRaceActivity.this)
                    .setRoomStatusUpdateListener(OldRaceActivity.this)
                    .setMessageReceivedListener(OldRaceActivity.this)
